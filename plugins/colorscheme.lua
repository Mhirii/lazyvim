...
local highlights = function(hl, c)
  ...
  if vim.g.neovide then
    ...
    hl.TelescopeBorder = { bg = c.transparent, fg = c.red }
    hl.TelescopePromptNormal = { bg = c.transparent }
    hl.TelescopePromptBorder = { bg = c.transparent, fg = c.red }
    hl.TelescopePromptTitle = { bg = c.transparent, fg = c.fg }
    hl.TelescopePreviewTitle = { bg = c.transparent, fg = c.fg }
    hl.TelescopeResultsTitle = { bg = c.transparent, fg = c.fg }
  end
...
local transparency = vim.g.neovide
